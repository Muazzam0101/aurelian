...
export function Footer() {
  ...
  return (
    <footer className="mt-24 border-t border-border bg-beige">
      <div className="max-w-[1400px] mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-6 gap-10">
        <div className="col-span-2">
          ...
          <div className="mt-5 flex gap-2">
            <input placeholder="Email address" className="h-10 px-4 rounded-full bg-background border border-border text-sm flex-1" />
            <button className="h-10 px-5 rounded-full bg-ink text-background text-xs uppercase tracking-widest">Join</button>
          </div>
        </div>
        {[
      ...
      <div className="border-t border-border/70">
        <div className="max-w-[1400px] mx-auto px-6 py-6">
          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar">
            {thumbs.map(p => (
              <Link key={p.id} to="/product/$id" params={{ id: p.id }} className="flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden bg-background">
      ...
      <div className="border-t border-border/70">
        <div className="max-w-[1400px] mx-auto px-6 py-5 flex flex-col md:flex-row justify-between gap-3 text-xs text-muted-foreground">
